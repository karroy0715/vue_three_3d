...
export default {
    ...
    methods:{
        init(){
            ...
            let planeGeometery = new THREE.PlaneGeometry(160,120,1,1);
            ...
            this.directionalLight = new THREE.DirectionalLight(pointColor);
            this.directionalLight.position.set(-40, 60, -10);
            this.directionalLight.shadowCameraNear = 2;
            this.directionalLight.shadowCameraFar = 200;
            this.directionalLight.shadowCameraLeft = -50;
            this.directionalLight.shadowCameraRight = 50;
            this.directionalLight.shadowCameraTop = 50;
            this.directionalLight.shadowCameraBottom = -50;
            ...
            // add a small sphere simulating the directionalLight
            ...
            gui.add(this.controls, 'target', ['Plane', 'Sphere', 'Cube']).onChange(function (e) {
                ...
                switch (e) {
                    case "Plane":
                        self.directionalLight.target = plane;
                        break;
                    case "Sphere":
                        self.directionalLight.target = sphere;
                        break;
                    case "Cube":
                        self.directionalLight.target = cube;
                        break;
                }
        ...
        animate(){
            ...
            if(!this.stopMovingLight){
                ...
                this.sphereLightMesh.position.z = 8;
                this.sphereLightMesh.position.y = +(27 * (Math.sin(this.step / 3)));
                this.sphereLightMesh.position.x = 10 + (26 * (Math.cos(this.step / 3)));
                this.directionalLight.position.copy(this.sphereLightMesh.position);
            }
